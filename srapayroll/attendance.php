...
<div class="page-layout">
    ...
    <div class="av-page-header">
        <div>
            <h2 class="av-page-title"><i class="fas fa-address-card"></i> Attendance</h2>
